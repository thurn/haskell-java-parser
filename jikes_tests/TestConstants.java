...
class Test
   ...
   aconst()
      {
      Object x;
      x = null; System.out.print("\nwant: null\n got: "); System.out.println(x); // aconst_null
      }
   ...
   iconst()
      {
      int  x;
      x = -1; System.out.print("\nwant: -1\n got: "); System.out.println(x);  // iconst_m1
      x =  0; System.out.print("\nwant: 0\n got: ");  System.out.println(x);  // iconst_0
      x =  1; System.out.print("\nwant: 1\n got: ");  System.out.println(x);  // iconst_1
      x =  2; System.out.print("\nwant: 2\n got: ");  System.out.println(x);  // iconst_2
      x =  3; System.out.print("\nwant: 3\n got: ");  System.out.println(x);  // iconst_3
      x =  4; System.out.print("\nwant: 4\n got: ");  System.out.println(x);  // iconst_4
      x =  5; System.out.print("\nwant: 5\n got: ");  System.out.println(x);  // iconst_5
      }
   ...
   lconst()
      {
      long x;
      x =  0; System.out.print("\nwant: 0\n got: "); System.out.println(x);  // lconst_0
      x =  1; System.out.print("\nwant: 1\n got: "); System.out.println(x);  // lconst_1
      }
   ...
   fconst()
      {
      float x;
      x =  0; System.out.print("\nwant: 0\n got: "); System.out.println(x);  // fconst_0
      x =  1; System.out.print("\nwant: 1\n got: "); System.out.println(x);  // fconst_1
      x =  2; System.out.print("\nwant: 2\n got: "); System.out.println(x);  // fconst_2
      }
   ...
   dconst()
      {
      double x;
      x =  0; System.out.print("\nwant: 0\n got: "); System.out.println(x);  // dconst_0
      x =  1; System.out.print("\nwant: 1\n got: "); System.out.println(x);  // dconst_1
      }

   static void
   misc()
      {
      byte  x0 =                 127; System.out.print("\nwant: 127\n got: ");                  System.out.println(x0);           // bipush
            x0 =                -127; System.out.print("\nwant: -127\n got: ");                 System.out.println(x0);           // bipush

      short x1 =               32767; System.out.print("\nwant: 32767\n got: ");                System.out.println(x1);           // sipush
            x1 =              -32767; System.out.print("\nwant: -32767\n got: ");               System.out.println(x1);           // sipush

      int   x2 =          0x7fffffff; System.out.print("\nwant: 2147483647\n got: ");           System.out.println(x2);           // ldc
            x2 =          0x80000001; System.out.print("\nwant: -2147483647\n got: ");          System.out.println(x2);           // ldc

      long  x4 = 0x7fffffffffffffffL; System.out.print("\nwant: 9223372036854775807\n got: ");  System.out.println(x4);           // ldc2_w
            x4 = 0x8000000000000001L; System.out.print("\nwant: -9223372036854775807\n got: "); System.out.println(x4);           // ldc2_w
   
                                      System.out.print("\nwant: X246\n got: ");                 System.out.println(new X().x246); // ldc_w
      }
   }
