...
class instance {
   ...
   public static void main (String aa[]) {
      ...
      if (((cost[])clone1)[0].price() == ((cost[])clonea[0])[0].price())
        result = result + 1;
      ...
      f2[0][1] = new Food(3);
      clonea[1] = f2;
      if (((cost[][])clonea[1])[0][0].price() == cxy[2].price())
        result = result + 1;
      oxy[0] = new Cans(4,3);
      oxy[1] = can1;
      oxy[2] = new Cans(15,2);
      ...
      if (oxy instanceof cost[] &&
          oxy[0] instanceof Food &&
          oxy[1] instanceof Cans) result = result + 1;
